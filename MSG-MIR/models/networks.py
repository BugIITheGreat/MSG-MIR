...
def define_G(input_nc, output_nc, ngf, netG, norm='batch', use_dropout=False, init_type='normal', init_gain=0.02,
    ...
    if netG == 'resnet_9blocks':
        ...
        net = MSGGenerator(depth=5, latent_size=256, use_eql=True)
    else:
...
def define_D(input_nc, ndf, netD, n_layers_D=3, norm='batch', init_type='normal', init_gain=0.02, gpu_ids=[]):
    ...
    if netD == 'basic':  # default PatchGAN classifier
        ...
        net = MSGDiscriminator(depth=5, feature_size=256, use_eql=True)
    else:
...
class UnetSkipConnectionBlock(nn.Module):
    ...
    def forward(self, x):
        if self.outermost:
            ...
            # print('X'+str(x.shape))
            # print('model'+str(self.model(x).shape))
...
class MSGGenerator(nn.Module):
    " Generator of the MSG-GAN network "
    ...
    def __init__(self, depth=7, latent_size=512, use_eql=True):
        ...
        from models.CustomLayers import GenGeneralConvBlock, \
...
class MSGDiscriminator(nn.Module):
    ...
    def __init__(self, depth=7, feature_size=512,
        ...
        from models.CustomLayers import DisGeneralConvBlock, \
